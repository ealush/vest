...
declare function getErrorsByGroup(
  groupName: string,
  fieldName: string
): string[];
declare function getWarningsByGroup(
  groupName: string
...
declare function hasErrorsByGroup(
  groupName: string,
  fieldName?: string
): boolean;
declare function hasWarningsByGroup(
  groupName: string,
  fieldName?: string
): boolean;
...
declare function create<T extends (...args: any[]) => void>(
  suiteCallback: T
): {
...
declare function testBase(
  fieldName: string,
  ...args: [message: string, cb: TTestFn]
): VestTest;
declare function testBase(fieldName: string, ...args: [cb: TTestFn]): VestTest;
declare const _default: typeof testBase & {
  each: (table: any[]) => {
    (
      fieldName: string | ((...args: any[]) => string),
      message: string | ((...args: any[]) => string),
      cb: (...args: any[]) => TTestResult
    ): VestTest[];
    (
      fieldName: string | ((...args: any[]) => string),
      cb: (...args: any[]) => TTestResult
