...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      SuiteResultTypes: resolve(
        __dirname,
        'src/suiteResult/SuiteResultTypes.ts',
      ),
      Severity: resolve(__dirname, 'src/suiteResult/Severity.ts'),
      useShouldAddValidPropertyInGroup: resolve(
        __dirname,
        'src/suiteResult/selectors/useShouldAddValidPropertyInGroup.ts',
      ),
      useSetValidProperty: resolve(
        __dirname,
        'src/suiteResult/selectors/useSetValidProperty.ts',
      ),
      useProduceSuiteSummary: resolve(
        __dirname,
        'src/suiteResult/selectors/useProduceSuiteSummary.ts',
      ),
      suiteSelectors: resolve(
        __dirname,
        'src/suiteResult/selectors/suiteSelectors.ts',
      ),
      hasFailuresByTestObjects: resolve(
        __dirname,
        'src/suiteResult/selectors/hasFailuresByTestObjects.ts',
      ),
      collectFailures: resolve(
        __dirname,
        'src/suiteResult/selectors/collectFailures.ts',
      ),
      ...
      validateSuiteParams: resolve(
        __dirname,
        'src/suite/validateParams/validateSuiteParams.ts',
      ),
      deferDoneCallback: resolve(
        __dirname,
        'src/suite/after/deferDoneCallback.ts',
      ),
      ...
      omitOptionalFields: resolve(
        __dirname,
        'src/hooks/optional/omitOptionalFields.ts',
      ),
      ...
      useHasOnliedTests: resolve(
        __dirname,
        'src/hooks/focused/useHasOnliedTests.ts',
      ),
      ...
      shouldUseErrorMessage: resolve(
        __dirname,
        'src/core/test/helpers/shouldUseErrorMessage.ts',
      ),
      nonMatchingSeverityProfile: resolve(
        __dirname,
        'src/core/test/helpers/nonMatchingSeverityProfile.ts',
      ),
      matchingFieldName: resolve(
        __dirname,
        'src/core/test/helpers/matchingFieldName.ts',
      ),
      ...
      VestIsolateType: resolve(
        __dirname,
        'src/core/isolate/VestIsolateType.ts',
      ),
      VestIsolate: resolve(__dirname, 'src/core/isolate/VestIsolate.ts'),
      IsolateReconciler: resolve(
        __dirname,
        'src/core/isolate/IsolateReconciler.ts',
      ),
      isSameProfileTest: resolve(
        __dirname,
        'src/core/isolate/IsolateTest/isSameProfileTest.ts',
      ),
      cancelOverriddenPendingTest: resolve(
        __dirname,
      ...
      TestWalker: resolve(
        __dirname,
        'src/core/isolate/IsolateTest/TestWalker.ts',
      ),
      IsolateTestReconciler: resolve(
        __dirname,
      ...
      IsolateSuite: resolve(
        __dirname,
        'src/core/isolate/IsolateSuite/IsolateSuite.ts',
      ),
      IsolateEach: resolve(
        __dirname,
        'src/core/isolate/IsolateEach/IsolateEach.ts',
      ),
      ...
      IsolateTestStateMachine: resolve(
        __dirname,
        'src/core/StateMachines/IsolateTestStateMachine.ts',
      ),
      CommonStateMachine: resolve(
        __dirname,
        'src/core/StateMachines/CommonStateMachine.ts',
      ),
    },
  },
});
