    ...
    describe('Base case', () => {
        ...
        it('Should match snapshot', () => {
            ...
            v = validate('eveniet-maxime-ea', () => {
                test('sed-minima-adipisci', 'Aliquam reprehenderit iure omnis assumenda eligendi enim id praesentium numquam.', () => {
                    enforce(1).equals(2);
                });
    ...
    describe('Exclusion via `only`', () => {
        ...
        it('Should match snapshot', () => {
            ...
            v = validate('inventore-quis-impedit', () => {
                ...
                test('doloribus-enim-quisquam', 'Ea quia saepe modi corrupti possimus similique expedita inventore.', () => {
    ...
    describe('Async tests', () => {
        ...
        it('Should match snapshot', (done) => {
            ...
            v = validate('molestias-veritatis-deserunt', () => {
                test('doloribus-enim-quisquam', 'Fuga odit ut quidem autem dolores ipsam.', () => Promise.resolve());
                test('doloribus-enim-quisquam', 'Fuga odit ut quidem autem dolores ipsam.', () => Promise.reject());
            });
            setTimeout(() => {
                expect(v).toMatchSnapshot();
                done();
