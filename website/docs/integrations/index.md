...
| Integration                                           | Status      | Tested versions                                                  | Mechanism            | Runtime | Types | Demo | Upstream   |
| ----------------------------------------------------- | ----------- | ---------------------------------------------------------------- | -------------------- | ------- | ----- | ---- | ---------- |
| [React Hook Form](/docs/integrations/react-hook-form) | local-green | Vest 6.3.2; react-hook-form 7.84.0 and @hookform/resolvers 5.7.1 | dedicated-adapter    | ✅      | ✅    | ⏳   | Not opened |
